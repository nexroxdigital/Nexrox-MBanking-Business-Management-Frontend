                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border rounded-lg p-3"
                      {...txnForm.register("receiverBank", { required: true })}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border rounded-lg p-3"
                      {...txnForm.register("receiverBankBranch", {
                        required: true,
                      })}
                    />
                  </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <select
                  className="w-full border rounded-lg p-3"
                  {...editTxnForm.register("bank", { required: true })}
                >
                  <option value="">ব্যাংক নির্বাচন করুন</option>
                  {bankNames.map((name, i) => (
                    <option key={i} value={name}>
              ...
              <div>
                ...
                <select
                  className="w-full border rounded-lg p-3"
                  {...editTxnForm.register("branch", { required: true })}
                >
                  <option value="">শাখা নির্বাচন করুন</option>
                  {getBranches(editTxnForm.watch("bank")).map((branch, i) => (
                    <option key={i} value={branch}>
                      {branch}
                    </option>
                  ))}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    const selected = getSenders(
                      editTxnForm.watch("bank"),
                      editTxnForm.watch("branch")
                    ).find((s) => s.name === e.target.value);
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full border rounded-lg p-3"
                  {...editTxnForm.register("receiverBankBranch")}
                />
              </div>
